...
<table width="993" height="102" border="0">
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="iphone 4">iphone 4</input></center></h1>
  <td width="10" height="10"><img src="images/Apple/iphone4.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  ios 8</input>
  ...
  Apple
		   ...
		   Price<hr color="blue"/><h5>
  <% if(rs.next()) out.println("Rs. "+rs.getString("pr"));%><input type="hidden" name="pr" value="<%=rs.getString("pr")%>"></input>
  </h5>
  </td>
  </tr>
 </table>  <h2><center><font color="lightGreen"><a href="spec3a.jsp">Full Technical Descaription</a><br><br>
 <table align="center">
 <td>
 <center>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="iphone 4"></input>
