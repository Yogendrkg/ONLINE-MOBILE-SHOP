...
<table width="993" height="102" border="0">
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="iphone 6">iphone 6</input></center></h1>
  <td width="10" height="10"><img src="images/Apple/iphone6.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
  ios 8</input>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="iphone 6"></input>
