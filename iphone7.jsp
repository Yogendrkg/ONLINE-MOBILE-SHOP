...
<table width="993" height="102" border="0">
  ...
  <tr>
  <h1><center> <input type="hidden" name="prod" value="iphone 7">iphone 7</input></center></h1>
  <td width="10" height="10"><img src="images/Apple/iphone7.jpg" width="400" height="500" />
  </td>
  <td><h3><center>
  Os<hr color="blue"/> <h5>
 ios 10</input>
 ...
 <center><button type="submit"><img width="150" height="80" src="images/AddCart.jpg"/></button> </center></td>
	<input type="hidden" name="prod" value="iphone 7"></input>
